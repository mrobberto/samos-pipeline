...
USE:
#Per star
PYTHONPATH=. python pipeline/step11_fluxcal/step11a_absolute_flux_from_skymapper_griz.py \
  --infile ../_Run8_Science_2026_01/SAMI/Dolidze25/reduced/08_extract1d/extract1d_optimal_ridge_all_wav.fits \
  --phot-cat config/reference_tables/photometry/skymapper_cache/skymapper_calstars_20260113.csv \
  --id-col SLITID \
  --r-col r_mag --i-col i_mag --z-col z_mag \
  --r-band calibration/reference_tables/filters/skymapper_r_nm.txt \
  --i-band calibration/reference_tables/filters/skymapper_i_nm.txt \
  --z-band calibration/reference_tables/filters/skymapper_z_nm.txt \
  --outdir ../_Run8_Science_2026_01/SAMI/Dolidze25/reduced/11_fluxcal \
  --mode perstar \
  --band-rms-rel-max 0.20 \
  --response-positive-frac-min 0.50 \
  --cond-max 1e14
...
PYTHONPATH=. python pipeline/step11_fluxcal/step11a_absolute_flux_from_skymapper_griz.py \
  ...
  --outdir ../_Run8_Science_2026_01/SAMI/Dolidze25/reduced/11_fluxcal \
  --mode master  \
  --response-positive-frac-min 0.90 \
  --cond-max 1e14 
"""
...
def infer_slit_id_from_hdu(hdu, idx: int) -> str:
    ...
    # Prefer human-readable slit names like EXTNAME=SLIT000
    ...
    # Fall back to numeric slit IDs and format them consistently
